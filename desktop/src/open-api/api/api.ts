...
export const APIS = [ApiKeyService, AuthService, BudgetService, CategoryService, CommentService, CustomFieldService, DashboardService, ExportService, FeatureConfigService, GroupsService, ImportService, NotificationsService, PermissionService, PromptService, ReceiptService, ReceiptImageService, ReceiptProcessingSettingsService, ReportService, RoleService, SearchService, SystemEmailService, SystemSettingsService, SystemTaskService, TagService, UserService, UserPreferencesService, WidgetService];
